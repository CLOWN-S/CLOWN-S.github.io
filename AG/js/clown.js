var onview = angular.module('App', ['ngRoute']);
onview.config(function($routeProvider, $locationProvider) {
	...
	$routeProvider
		...
		.when('/shanchu', {
				templateUrl: 'shanchu.html',
				controller: 'Shanchu'
		})
		.when('/pbi', {
				templateUrl: 'pbi.html',
				controller: 'Pbi'
		})
		.when('/toushu', {
				templateUrl: 'toushu.html',
				controller: 'Toushu'
		})
		.when('/pl', {
				templateUrl: 'pl.html',
...
onview.controller('Ctrl', function($scope) {
	$scope.flag = "";
	$scope.isUp1 = true;
	$scope.isUp2 = true;
	$scope.isUp3 = true;
	...
	$scope.flag2 = false;
	$scope.flag3 = false;
	$scope.change1 = function(order) {
		var ipt=sessionStorage.getItem('pds');
		if(ipt){
		if($scope.isUp1) {
			$scope.flag = "-"
			$scope.isUp1 = false;
...
//	逻辑控制器
	.controller('Shouye', function($scope) {
		$scope.init = function() {
			...
			var myChart1 = echarts.init(document.getElementById('amain'));
			var colors = ['#5793f3', '#d14a61', '#675bba'];
			var waterMarkText = 'Clown';
			var dataMap = {};
			option = {
				color: colors,
		    ...
		    var pList = ['番剧','游戏','宅舞','原创','科技','直播','音乐','MAD','AMV','三次元','二次元','鬼畜','电视剧','生活','娱乐','时尚','舞蹈','国创','游戏中心','音乐','动画','新番','其他','贵州','云南','西藏','陕西','甘肃','青海','宁夏','新疆'];
		    var temp;
		...
		dataMap.dataFinancial = dataFormatter({
			...
			option = {
			    baseOption: {
			        ...
			        legend: {
			            x: 'right',
			            data: ['原创投稿', '搬运投稿', '二次创作', '广告', '游戏', '其他'],
			            selected: {
			                '广告': false, '游戏': false, '其他': false
			            }
			        },
			        calculable : true,
			        grid: {
			    ...
			    options: [
			        {
			            ...
			            series: [
			                ...
			                {data: [
			                    {name: '原创投稿', value: dataMap.dataPI['2002sum']},
			                    {name: '搬运投稿', value: dataMap.dataSI['2002sum']},
			                    {name: '二次创作', value: dataMap.dataTI['2002sum']}
			                ]}
			            ]
			        },
			        {
			            title : {text: '2016全站弹幕统计'},
			            series : [
			                ...
			                {data: [
			                    {name: '原创投稿', value: dataMap.dataPI['2003sum']},
			                    {name: '搬运投稿', value: dataMap.dataSI['2003sum']},
			                    {name: '二次创作', value: dataMap.dataTI['2003sum']}
			                ]}
			            ]
			        },
			        {
			            title : {text: '2015全站弹幕统计'},
			            series : [
			                ...
			                {data: [
			                    {name: '原创投稿', value: dataMap.dataPI['2004sum']},
			                    {name: '搬运投稿', value: dataMap.dataSI['2004sum']},
			                    {name: '二次创作', value: dataMap.dataTI['2004sum']}
			                ]}
			            ]
			        },
			        {
			            title : {text: '2005全站弹幕统计'},
			            series : [
			                ...
			                {data: [
			                    {name: '原创投稿', value: dataMap.dataPI['2005sum']},
			                    {name: '搬运投稿', value: dataMap.dataSI['2005sum']},
			                    {name: '二次创作', value: dataMap.dataTI['2005sum']}
			                ]}
			            ]
			        },
			        {
			            title : {text: '2006全站弹幕统计'},
			            series : [
			                ...
			                {data: [
			                    {name: '原创投稿', value: dataMap.dataPI['2006sum']},
			                    {name: '搬运投稿', value: dataMap.dataSI['2006sum']},
			                    {name: '二次创作', value: dataMap.dataTI['2006sum']}
			                ]}
			            ]
			        },
			        {
			            title : {text: '2007全站弹幕统计'},
			            series : [
			                ...
			                {data: [
			                    {name: '原创投稿', value: dataMap.dataPI['2007sum']},
			                    {name: '搬运投稿', value: dataMap.dataSI['2007sum']},
			                    {name: '二次创作', value: dataMap.dataTI['2007sum']}
			                ]}
			            ]
			        },
			        {
			            title : {text: '2008全站弹幕统计'},
			            series : [
			                ...
			                {data: [
			                    {name: '原创投稿', value: dataMap.dataPI['2008sum']},
			                    {name: '搬运投稿', value: dataMap.dataSI['2008sum']},
			                    {name: '二次创作', value: dataMap.dataTI['2008sum']}
			                ]}
			            ]
			        },
			        {
			            title : {text: '2009全站弹幕统计'},
			            series : [
			                ...
			                {data: [
			                    {name: '原创投稿', value: dataMap.dataPI['2009sum']},
			                    {name: '搬运投稿', value: dataMap.dataSI['2009sum']},
			                    {name: '二次创作', value: dataMap.dataTI['2009sum']}
			                ]}
			            ]
			        },
			        {
			            title : {text: '2010全站弹幕统计'},
			            series : [
			                ...
			                {data: [
			                    {name: '原创投稿', value: dataMap.dataPI['2010sum']},
			                    {name: '搬运投稿', value: dataMap.dataSI['2010sum']},
			                    {name: '二次创作', value: dataMap.dataTI['2010sum']}
			                ]}
			            ]
			        },
			        {
			            title : {text: '2011全站弹幕统计'},
			            series : [
			                ...
			                {data: [
			                    {name: '原创投稿', value: dataMap.dataPI['2011sum']},
			                    {name: '搬运投稿', value: dataMap.dataSI['2011sum']},
			                    {name: '二次创作', value: dataMap.dataTI['2011sum']}
			                ]}
			            ]
			        }
			    ]
...
//	逻辑控制器
.controller('ahouye', function($scope) {
	$scope.init = function() {
	var str=document.getElementsByClassName('secondbox')[0];
	$.ajax({
	    type:'GET',
	    url:'juhe.json',
	    dataType:"json",
	    ...
	    resultData.forEach(function (item,index) {
	    	...
	    	str += `<div class="footer-box"><img class="footer-img" src="${item.thumbnail_pic_s}" /><p class="footer-text">${item.title}</p><i class="icon-huihua1 iconfont"></i><span class="footer-text2">${item.date}</span><input class="huifu" type="button" value="恢复"/><input class="shanchu" type="button" value="删除" ng-click="delete()"/></div><hr />`;
		}
	    })
		document.querySelector('.secondbox').innerHTML = str;
		
		var afooterbox=document.getElementsByClassName('footer-box'),
		 hr=document.getElementsByTagName('hr'),
	 	 pb=document.getElementsByClassName('shanchu'),
	 	 huifu=document.getElementsByClassName('huifu');
		for(var i=0;i<afooterbox.length;i++){
		pb[i].index=i;
		pb[i].onclick=function(){
			var _index=this.index;
			afooterbox[_index].style.display="none"
			hr[_index].style.display="none"
		}
		}		
		for(var j=0;j<afooterbox.length;j++){
		huifu[j].index=j;
		huifu[j].onclick=function(){
			var _index=this.index;
			afooterbox[_index].style.display="none"
			hr[_index].style.display="none"
		}
	...
	$scope.delete = function () {
            for(var i=0;i<$scope.datas.length;i++){
                    $scope.data.result.data.splice(i,1)
                    return
                }
            }
	})

.controller('fans', function($scope) {
	$scope.init = function() {
		var fi=document.querySelector('input[type="file"]'),
			si=document.querySelector('input[type="text"]'),
			ai=document.querySelector('input[type="submit"]'),
			oul=document.getElementsByClassName('auc')[0],
			img=document.querySelector('img');
			ai.onclick = function(){
				for(var i=0;i<fi.files.length;i++){
					var _file=fi.files[i]
					if(_file.type.indexOf('image/')!==-1){
						var file=new FileReader();
						file.readAsDataURL(fi.files[i])
						file.onload=function(e){
							oul.innerHTML+="<li><img src='"+e.target.result+"' width='200px'/><p style='display:inline-block;font-size:20px'>"+si.value+"</p></li><hr/>"
						}
					}
				}
			}
...
.controller('third', function($scope) {
	...
	$.ajax({
	    ...
	    success:function (data) {
	        ...
	        var str = '';
	    resultData.forEach(function (item,index) {
	    	str += `<div class="footer-box"><img class="footer-img" src="${item.thumbnail_pic_s}" /><p class="footer-text">${item.title}</p><i class="icon-huihua1 iconfont"></i><span class="footer-text2">${item.date}</span><input class="pbi" type="button" value="屏蔽"/><input class="shanchu" type="button" value="删除"/></div><hr />`;
		})
		document.querySelector('.secondbox').innerHTML = str;
		var afooterbox=document.getElementsByClassName('footer-box'),
	 	 pb=document.getElementsByClassName('shanchu'),
	 	 hr=document.getElementsByTagName('hr'),
	 	 pbi=document.getElementsByClassName('pbi');
	for(var i=0;i<29;i++){
		pb[i].index=i;
		pb[i].onclick=function(){
			var _index=this.index;
...
.controller('Load', function($scope) {
	$scope.init = function() {
		var fi=document.querySelector('input[type="text"]'),
			si=document.querySelector('input[type="password"]'),
			ai=document.querySelector('input[type="submit"]');
			aa=document.getElementsByClassName('loada')[0],
			ai.onclick=function(){
				if(fi.value==''||si.value==''){
				alert('请输入用户名和密码')
				}else{
				setCookie('text',fi.value,30);
				setCookie('password',si.value,30);
				alert('提交成功');
				}
			}
			}
...
.controller('Firsta', function($scope) {
	$scope.init = function() {
		var firstli=document.getElementsByClassName('firstli')[0],
			fi=document.querySelector('input[type="text"]'),
			si=document.querySelector('input[type="password"]'),
			firsttext=document.getElementsByClassName('firsttext')[0],
			span1=document.getElementsByClassName('span1')[0],
			span2=document.getElementsByClassName('span2')[0],
			textword=getCookie('text');
			textpass=getCookie('password');
			span1.onclick=function(){
				if(fi.value==textword||si.value==textpass){
				alert('登录成功');
				sessionStorage.setItem('pds',1);
				firstli.textContent="欢迎:"+ textword;
				firsttext.textContent="欢迎"+ textword+"会员,请点击菜单选项";
				fi.value='';
				si.value='';
				}else{
					alert("用户名或者密码错误")
...
.controller('Shanchu', function($scope) {
	$scope.init = function() {
	$.ajax({
	    type:'GET',
	    url:'juhe.json',
	    ...
	    resultData.forEach(function (item,index) {
	    	...
	    	str += `<div class="footer-box"><img class="footer-img" src="${item.thumbnail_pic_s}" /><p class="footer-text">${item.title}</p><i class="icon-huihua1 iconfont"></i><span class="footer-text2">${item.date}</span><input class="ashanchu" type="button" value="彻底删除"/></div><hr />`;
		}
	    })
		document.querySelector('.secondbox').innerHTML = str;
		...
		var afooterbox=document.getElementsByClassName('footer-box'),
		 hr=document.getElementsByTagName('hr'),
	 	 pb=document.getElementsByClassName('ashanchu');
		for(var i=0;i<afooterbox.length;i++){
		pb[i].index=i;
		pb[i].onclick=function(){
			var _index=this.index;
...
.controller('Pbi', function($scope) {
	...
	$.ajax({
	    ...
	    resultData.forEach(function (item,index) {
	    	...
	    	str += `<div class="footer-box"><img class="footer-img" src="${item.thumbnail_pic_s}" /><p class="footer-text">${item.title}</p><i class="icon-huihua1 iconfont"></i><span class="footer-text2">${item.date}</span><input class="bshanchu" type="button" value="恢复屏蔽"/></div><hr />`;
		}
	    })
		document.querySelector('.secondbox').innerHTML = str;
		...
		var afooterbox=document.getElementsByClassName('footer-box'),
		hr=document.getElementsByTagName('hr'),
	 	pb=document.getElementsByClassName('bshanchu');
		for(var i=0;i<afooterbox.length;i++){
		pb[i].index=i;
		pb[i].onclick=function(){
			var _index=this.index;
...
.controller('Toushu', function($scope) {
	$scope.init = function() {
	$.ajax({
	    type:'GET',
	    url:'juhe.json',
	    ...
	    resultData.forEach(function (item,index) {
	    	if(index>=5&&index<=5){
	    	str += `<div class="footer-box"><img class="footer-img" src="${item.thumbnail_pic_s}" /><p class="footer-text">${item.title}</p><i class="icon-huihua1 iconfont"></i><span class="footer-text2">${item.date}</span><input class="shanchu" type="button" value="处理"/><input class="shanchu" type="button" value="详情"/></div><hr />`;
		}
	    })
		document.querySelector('.secondbox').innerHTML = str;
	}    
...
.controller('Pl', function($scope) {
	...
	$.ajax({
	    ...
	    success:function (data) {
	        ...
	        var str = '';
	    resultData.forEach(function (item,index) {
	    	str += `<div class="footer-box"><p class="footer-text">${item.title}</p><i class="icon-huihua1 iconfont"></i><span class="footer-text2">${item.date}</span><input class="shanchu" type="button" value="管理"/><input class="shanchu" type="button" value="更多"/></div><hr />`;
	    })
		document.querySelector('.secondbox').innerHTML = str;
	}    
	})
